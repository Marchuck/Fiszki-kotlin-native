...
package com.marchuck.fiszki.view;
...
public class ShimmerRecyclerView extends RecyclerView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            setDemoLayoutReference(a.getResourceId(R.styleable.ShimmerRecyclerView_shimmer_demo_layout, R.layout.layout_shimmer_view));
